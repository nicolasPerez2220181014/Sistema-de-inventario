...
CREATE TABLE Products (product_serial  SERIAL NOT NULL, product_name varchar(30), product_sell_price numeric(19, 0), product_expires_date date, product_stock int4, product_image int4, Fk_category_id int4, Fk_Typestype_id int4, Fk_Supplier_id int4, PRIMARY KEY (product_serial));
...
CREATE TABLE Bills_Products (units int4, discount numeric(19, 0), total numeric(19, 0), tax numeric(19, 0), Fk_product_serial int4 NOT NULL, Fk_bill_id int4 NOT NULL, PRIMARY KEY (Fk_product_serial, Fk_bill_id));
...
ALTER TABLE Bills_Products ADD CONSTRAINT FKBills_Prod855415 FOREIGN KEY (Fk_product_serial) REFERENCES Products (product_serial);
